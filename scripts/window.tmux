...
_tmux_input_text="#[fg=$tmux_red][READONLY]#[fg=default]"
_tmux_input_indicator="#{?pane_input_off,$_tmux_input_text,}"
...
set-window-option -g pane-border-format "$_tmux_prefix_indicator$_tmux_input$_tmux_sync_indicator$_tmux_mode_indicator $_tmux_pane_path"
